...
const Wallet = () => {
  ...
  return (
    <div className="min-h-screen bg-[var(--color-customBackground-default)] font-sans text-[var(--color-customText-primary)] flex flex-col">
      ...
      <main className="flex-1 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <h1 className="text-2xl font-extrabold tracking-tight text-[var(--color-primary-dark)]">My Wallet</h1>
      ...
      {/* Page Footer */}
      <footer className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 mt-auto flex flex-col md:flex-row items-center justify-between text-[10px] font-bold tracking-widest text-[var(--color-customText-disabled)] uppercase border-t border-[var(--color-customBorder-light)]">
        <div className="flex items-center gap-2 mb-4 md:mb-0">
          <ShieldCheck className="w-4 h-4" />
          <span>Enterprise Encrypted Protocol Active - Server Status: Operational (99.98% Uptime)</span>
        </div>
        <div>
          © 2024 INFRAMART GLOBAL LOGISTICS • DASHBOARD V4.3.0
        </div>
      </footer>
