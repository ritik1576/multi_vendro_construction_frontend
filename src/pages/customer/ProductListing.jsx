      ...
      <div className="min-h-screen flex flex-col bg-[#F8FAFC] font-sans text-[#0F172A]">
        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <main className="flex-1 overflow-y-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <button 
              className="lg:hidden w-full mb-6 py-2.5 bg-white border border-slate-200 rounded-md text-sm font-bold shadow-sm flex justify-center items-center gap-2"
            ...
            {!isLoading && !error && filteredProducts.length > 0 && (
              <div className="mt-12 pt-6 border-t border-slate-200 flex items-center justify-center gap-2">
                ...
                <button className="w-8 h-8 flex items-center justify-center bg-[#0F172A] text-white font-bold text-sm">1</button>
                <button className="w-8 h-8 flex items-center justify-center text-slate-500 hover:bg-slate-100 font-bold text-sm">2</button>
                <button className="w-8 h-8 flex items-center justify-center text-slate-500 hover:bg-slate-100 font-bold text-sm">3</button>
                <span className="px-2 text-slate-400">...</span>
                <button className="w-8 h-8 flex items-center justify-center text-slate-500 hover:bg-slate-100 font-bold text-sm">24</button>
                <button className="p-2 text-slate-400 hover:text-slate-800">›</button>
              </div>
            )}
          </main>
