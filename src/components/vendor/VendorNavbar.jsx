      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="flex-shrink-0 flex items-center gap-1">
            <Link to="/vendor/dashboard" className="text-[28px] font-extrabold tracking-tight flex items-center">
              ...
              <span className="ml-2 rounded-md bg-slate-100 px-2 py-0.5 text-xs font-bold text-slate-600">Vendor</span>
            </Link>
          </div>

          {/* Actions */}
          <div className="flex items-center space-x-4 md:space-x-4 ml-auto">
            <button className="text-slate-500 hover:text-[#1E3A8A] p-2 rounded-md hover:bg-orange-50 transition-colors relative">
